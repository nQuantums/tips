...
//	public class Values<TColumns> : IValues<TColumns> {
//		#region プロパティ
//		/// <summary>
//		/// ノードが属するSQLオブジェクト
//		/// </summary>
...
//		/// <summary>
//		/// <see cref="IDbCodeDataReader"/>から<see cref="TColumns"/>を列挙するファンクション
//		/// </summary>
//		public Func<IDbCodeDataReader, IEnumerable<TColumns>> Reader => TypeWiseCache<TColumns>.Reader;

//		/// <summary>
//		/// 行を列挙
//		/// </summary>
//		public List<TColumns> Rows { get; private set; } = new List<TColumns>();
//		IEnumerable<TColumns> IValues<TColumns>.Rows => this.Rows;
//		#endregion
...
//		public Values(IQueryNode parent, PropertyInfo[] properties, ElementCode[] values) {
...
//		/// <param name="properties">列に対応するプロパティ</param>
//		/// <param name="values">列の値の式</param>
//		public Values(IQueryNode parent, PropertyInfo[] properties, Expression[] values) {
//			if (properties.Length != values.Length) {
//				throw new ApplicationException();
//			}
...
//		public Values(IQueryNode parent, Expression<Func<TColumns>> columnsExpression) {
//			this.Parent = parent;

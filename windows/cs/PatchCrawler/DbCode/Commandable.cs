...
namespace DbCode {
	...
	public class Commandable {
		...
		public int Execute(IDbCodeCommand command) => command.ExecuteNonQuery(this);
		...
		public IDbCodeDataReader ExecuteReader(IDbCodeCommand command) => command.ExecuteReader(this);
	}
}
